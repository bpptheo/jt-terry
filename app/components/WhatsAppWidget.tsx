...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-4">
      {/* Expanded state - minimal chat bubble */}
      <div
      ...
      >
        <div className="bg-white rounded-2xl shadow-2xl ring-1 ring-black/10 p-4 max-w-[240px]">
          <p className="text-gray-700 text-sm leading-relaxed">
            Hey! Got any questions? Send me a message on WhatsApp.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <svg
            className={`w-6 h-6 text-white transition-transform duration-300 ${isOpen ? "rotate-0" : "rotate-0"}`}
