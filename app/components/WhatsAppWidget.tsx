...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden w-72">
          {/* Header */}
          <div className="bg-deep-blue px-5 py-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-sunny-yellow rounded-full flex items-center justify-center">
                <span className="text-deep-blue font-bold text-sm">TA</span>
              </div>
              <div>
                <p className="text-white font-semibold text-sm">Terry Agbenyo</p>
          ...
          <div className="p-4 bg-gray-50">
            <div className="bg-white rounded-2xl rounded-tl-sm p-3 shadow-sm max-w-[85%]">
              <p className="text-gray-700 text-sm">
                Hello! How can I help you today? Feel free to send me a message.
              </p>
          ...
          <div className="p-4 pt-0 bg-gray-50">
            <a
              ...
              className="flex items-center justify-center gap-2 w-full bg-[#25D366] hover:bg-[#20BD5A] text-white font-medium py-3 px-4 rounded-2xl transition-colors"
            >
      ...
      <button
        ...
        className={`w-14 h-14 rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 ${
          isOpen
            ...
            : "bg-[#25D366] hover:bg-[#20BD5A] animate-bounce-gentle"
        }`}
